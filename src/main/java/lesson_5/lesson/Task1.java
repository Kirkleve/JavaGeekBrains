...
public class Task1 {
    ...
    public static  Map<String, List<Integer>> surnameMap = Map.of("Иванов", List.of(123456, 234432, 345678),
    ...
    public static void passportNumberBySurname1 (String surname) {
        ...
        for (Map.Entry<Integer, String> entry : entries) {
            if (entry.getValue().equals(surname)) System.out.println(entry.getKey());
        }
    }
